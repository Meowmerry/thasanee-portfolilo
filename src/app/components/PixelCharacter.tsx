...
interface PixelCharacterProps {
  ...
  skin: string;
  scale?: number;
  /** Optional class accent — overrides the outfit's trim/detail color (tie, strings, neon). */
  accent?: string;
  /** Optional paint — overrides the outfit's top (shirt/jacket) color. */
  top?: string;
}
...
export function PixelCharacter({
    ...
    // Outfit paint — recolor the top (shirt/jacket) to the chosen color
    if (top) colors.top = top;

    // Class accent — recolor the outfit's trim/detail to the selected class color
    if (accent) colors.detail = accent;
